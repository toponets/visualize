...
document.addEventListener("DOMContentLoaded", () => {
  initializeVisualizer().catch((error) => {
    console.error(error);
    renderErrorMessage("Visualization could not be initialized. See the console for details.");
  });
});
...
class DigitSketchPad {
  ...
  buildGrid() {
    ...
    title.textContent = "Draw your input here";
...
class ProbabilityPanel {
  ...
  build() {
    ...
    title.textContent = "Output Probabilities";
    this.container.appendChild(title);
...
class NetworkInfoPanel {
  ...
  build() {
    ...
    this.titleElement.textContent = "Network Architecture";
